          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
               ...
               Become a Full Stack Web Developer using HTML, CSS, JavaScript, React, Node.js and modern web technologies.
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <p className="text-gray-600 text-lg leading-8 mb-6">
          Web development is one of the most in-demand technology skills worldwide.
  This course teaches students how to design, build, and deploy responsive,
  modern websites using industry-standard technologies and best practices.
        </p>

        <p className="text-gray-600 text-lg leading-8">
          Throughout the training, students will master HTML, CSS, JavaScript, React,
  Node.js, and modern development tools while creating professional web
  applications that demonstrate their skills to employers.
        </p>
      ...
      <div className="grid gap-5">
        ...
        <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
          ...
          <p className="mt-3 text-gray-600">
            Prepare for internships, freelance work and full-time web development careers.
          </p>
