          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
                ...
                Master Machine Learning, Deep Learning, Prompt Engineering,
                Generative AI and real-world AI applications through practical
                hands-on projects.
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <p className="text-gray-600 text-lg leading-8 mb-6">
          ...
          and finance to education and business automation. This course equips
          you with the knowledge and practical experience needed to build
          intelligent solutions using modern AI technologies.
        </p>

        <p className="text-gray-600 text-lg leading-8">
          Throughout the training you'll work on real-world projects, develop
          portfolio-ready applications, and learn directly from experienced
