          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
                ...
                Build a strong foundation in networking by mastering Cisco routing, switching, network security, wireless technologies, and enterprise network management.
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <p className="text-gray-600 text-lg leading-8 mb-6">
          Modern organizations depend on secure and reliable computer networks. This
  course provides the knowledge and practical skills needed to install,
  configure, maintain, and troubleshoot enterprise network infrastructures.

        </p>

        <p className="text-gray-600 text-lg leading-8">
          Throughout the training, students will learn routing, switching, wireless
  networking, network security, and Cisco technologies through hands-on labs
  that prepare them for industry certifications and professional networking
  careers.
        </p>
