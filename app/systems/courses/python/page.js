          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
                ...
                Master Python programming from beginner to advanced through practical coding exercises, automation projects, web development and real-world applications.
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <p className="text-gray-600 text-lg leading-8 mb-6">
          Python is one of the world's most popular programming languages and is used
  in web development, automation, data analysis, artificial intelligence, and
  software engineering. This course provides a strong foundation in Python
  programming through practical coding exercises and real-world projects.

        </p>

        <p className="text-gray-600 text-lg leading-8">
          Throughout the training, students will learn programming fundamentals,
  object-oriented programming, file handling, APIs, and application
  development while building portfolio-ready projects that prepare them for
  professional software development careers.
        </p>
      ...
      <div className="grid gap-5">
        ...
        <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
          ...
          <p className="mt-3 text-gray-600">
            Build portfolio-quality AI applications using modern tools.
          </p>
        ...
        <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
          ...
          <p className="mt-3 text-gray-600">
            Prepare for internships, freelance work and full-time AI careers.
          </p>
    ...
    <div className="relative overflow-hidden rounded-[40px] border border-gray-200 bg-white px-10 py-20 shadow-[0_25px_60px_rgba(13,110,253,0.12)]">
      ...
      <div className="relative text-center">
        ...
        <p className="mt-6 max-w-3xl mx-auto text-lg leading-8 text-gray-600">
          Join thousands of students learning the most in-demand technology
          skills through industry-focused training, practical projects and
          expert instructors at COTSLE Systems.
        </p>
