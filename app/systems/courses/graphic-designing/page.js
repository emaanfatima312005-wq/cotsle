    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-[#0d1b35] to-slate-900 text-white py-24">
        ...
        <div className="absolute inset-0 opacity-10">
          <Image
            src="/images/graphic_Designing.jpg"
            alt=""
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
                ...
                Develop professional graphic design skills and learn how to
                create creative visual content, branding materials, digital
                graphics and engaging designs using modern design tools.
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 mb-6">
                Graphic designing plays an important role in modern branding,
                advertising and digital communication. This course introduces
                students to design principles, visual communication and
                creative techniques used to create professional designs.

              </p>

              <p className="text-gray-600 text-lg leading-8">
                Throughout the training, students will gain hands-on
                experience with typography, color theory, branding, digital
                graphics and modern design tools while creating practical
                projects for real-world applications.
              </p>
            ...
            <div className="grid gap-5">
              ...
              <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
                ...
                <h3 className="text-xl font-bold text-gray-900">
                  Branding & Digital Graphics
                </h3>

                <p className="mt-3 text-gray-600">
                  Learn how to create professional branding materials,
                  marketing graphics and digital content.
                </p>
              ...
              <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
                ...
                <p className="mt-3 text-gray-600">
                  Prepare for freelance opportunities, internships and
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border p-8">
              ...
              <p className="mt-3 text-gray-600">
                Branding & Digital Content Design
              </p>
            </div>
            ...
            <div className="rounded-2xl border p-8">
              ...
              <p className="mt-3 text-gray-600">
                Complete Branding & Graphic Design Project
              </p>
            </div>
          ...
          <div className="relative overflow-hidden rounded-[40px] border border-gray-200 bg-white px-10 py-20 shadow-[0_25px_60px_rgba(13,110,253,0.12)]">
            ...
            <div className="relative text-center">
              ...
              <p className="mt-6 max-w-3xl mx-auto text-lg leading-8 text-gray-600">
                ...
                technology and professional skills through industry-focused
                training, practical projects and expert instructors at
                COTSLE Systems.
              </p>
