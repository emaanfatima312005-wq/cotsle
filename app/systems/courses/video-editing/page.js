          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
                ...
                Master professional video editing, storytelling, visual effects, transitions, audio editing and modern techniques to create engaging digital video content.
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 mb-6">
                Video editing is an essential skill for digital media,
                entertainment, marketing and online content creation. This
                course introduces students to professional video editing
                principles and creative storytelling techniques.
              </p>

              <p className="text-gray-600 text-lg leading-8">
                Throughout the training, students will gain hands-on experience
                with video editing, transitions, effects, color correction,
                audio editing and content creation while developing practical
            ...
            <div className="grid gap-5">
              ...
              <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
                ...
                <p className="mt-3 text-gray-600">
                  Learn how to create engaging stories through professional
              ...
              <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
                ...
                <p className="mt-3 text-gray-600">
                  Prepare for freelance work, content creation and professional
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border p-8">
              ...
              <p className="mt-3 text-gray-600">
                Editing Techniques & Timeline Management
              </p>
            </div>
            ...
            <div className="rounded-2xl border p-8">
              ...
              <p className="mt-3 text-gray-600">
                Transitions, Effects & Visual Elements
              </p>
            </div>
            ...
            <div className="rounded-2xl border p-8">
              ...
              <p className="mt-3 text-gray-600">
                Color Correction & Advanced Editing
              </p>
            </div>
