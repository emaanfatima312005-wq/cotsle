    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-[#0d1b35] to-slate-900 text-white py-24">
        ...
        <div className="absolute inset-0 opacity-10">
          <Image
            src="/images/app_development.jpg"
            alt=""
            fill
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
                ...
                Learn modern application development concepts and build
                functional, user-friendly applications using practical
                development techniques and industry-standard tools.
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 mb-6">
                ...
                Application development has become an essential part of
                today's digital world. This course introduces you to the
                fundamentals of application development and modern
                technologies used to create functional applications.
              ...
              <p className="text-gray-600 text-lg leading-8">
                ...
                with application development concepts, user interfaces,
                application logic and development workflows while building
            ...
            <div className="grid gap-5">
              ...
              <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
                ...
                <p className="mt-3 text-gray-600">
                  Learn modern application development concepts and workflows.
                </p>
              ...
              <div className="rounded-2xl border border-gray-200 p-6 hover:shadow-xl transition">
                ...
                <p className="mt-3 text-gray-600">
                  Build practical applications while learning development
                  techniques used in the technology industry.
                </p>
