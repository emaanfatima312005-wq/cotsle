          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-8 text-lg text-gray-300 leading-8 max-w-xl">
                ...
                Master AWS, Microsoft Azure, cloud infrastructure, virtualization, containers, and modern deployment practices to build scalable cloud-based solutions.
    ...
    <div className="grid lg:grid-cols-2 gap-16 items-center">
      ...
      <div>
        ...
        <p className="text-gray-600 text-lg leading-8 mb-6">
          Cloud computing has transformed how businesses build and manage technology
  infrastructure. This course introduces students to cloud platforms,
  virtualization, and scalable deployment using today's leading cloud
  technologies.

        </p>

        <p className="text-gray-600 text-lg leading-8">
          Throughout the training, students will gain hands-on experience with AWS,
  Microsoft Azure, Docker, Kubernetes, and cloud deployment while building
  practical cloud-based solutions for real-world business environments.
        </p>
